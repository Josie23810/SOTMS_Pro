...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($current_password) || empty($new_password) || empty($confirm_password)) {
        ...
        try {
            ...
            $messageType = 'error';
            error_log('Tutor settings error: ' . $e->getMessage());
        }
    }
}
?>
...
<head>
    ...
    <title>Tutor Settings - SOTMS PRO</title>
    ...
    <style>
        ...
        .settings-panel { background: white; border: 1px solid #e2e8f0; border-radius: 14px; padding: 22px; }
        .settings-panel h2 { margin-top: 0; color: #111827; }
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Update your tutor account credentials and manage security settings.</p>
        </div>
        <div class="nav">
            ...
            <div class="card">
                <div class="settings-grid">
                    ...
                    <div class="settings-panel">
                        ...
                        <p>Keep your account secure and make sure your tutor profile stays up to date.</p>
                        <ul style="padding-left: 20px; color: #4b5563;">
                            <li>Securely update your password.</li>
                            <li>Review your tutor profile information.</li>
                            <li>Contact support if you need help with your account.</li>
                        </ul>
                        <a href="profile.php" class="btn" style="margin-top: 12px; display: inline-block;">Edit Profile</a>
                    </div>
                </div>
            </div>
        </div>
